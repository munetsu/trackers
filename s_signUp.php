    ...
    <div>
        ...
        <div class="itemList">
            ...
            <form action="s_signUp_confirm.php" method="POST" name="signUp">
                ...
                <p>NAME<span>*</span>：<input type="text" name="a_familyname" class="text alpha" placeholder="(例)tanaka"><input type="text" name="a_firstname" class="text alpha" placeholder="(例)tarou"></p>
